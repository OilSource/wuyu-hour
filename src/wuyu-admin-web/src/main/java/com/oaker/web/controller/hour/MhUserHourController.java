...
import com.oaker.hours.doman.dto.UserHourApproveDTO;
...
public class MhUserHourController extends BaseController {
     ...
     */
    @PutMapping("/approve")
    @PreAuthorize("@ss.hasPermi('mh:hour:approve')")
    public AjaxResult approveHour(@Validated @RequestBody UserHourApproveDTO userHourApproveDTO) {
        boolean result = userHourService.approveUserHour(userHourApproveDTO);
        return toAjax(result);
    }
