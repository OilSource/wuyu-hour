...
-- ----------------------------
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('OakerScheduler', 'c7601ca489e01675841866780', 1675842094978, 15000);
...
-- ----------------------------
INSERT INTO `QRTZ_TRIGGERS` VALUES ('OakerScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1675841870000, -1, 5, 'PAUSED', 'CRON', 1675841866000, 0, NULL, -1, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('OakerScheduler', 'TASK_CLASS_NAME100', 'DEFAULT', 'TASK_CLASS_NAME100', 'DEFAULT', NULL, 1675875600000, -1, 5, 'WAITING', 'CRON', 1675841867000, 0, NULL, -1, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('OakerScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1675841880000, -1, 5, 'PAUSED', 'CRON', 1675841866000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('OakerScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1675841880000, -1, 5, 'PAUSED', 'CRON', 1675841867000, 0, NULL, 2, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 610 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 613 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '系统管理员', '01', '123456@123.com', '18888888888', '1', '/profile/avatar/2023/02/08/ed22d20e-952a-4c6d-9ae3-1d25d8ec343a.jpeg', '$2a$10$G7MIGBZKPDSD.zGpDPRiJeV3HuOXxk4qEVdQAaZ8pmHHaVRoiDIom', '0', '0', '172.18.0.5', '2023-02-08 15:38:12', 'admin', '2021-08-22 08:37:02', '', '2023-02-08 15:38:12', '管理员');
