...
-- ----------------------------
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('OakerScheduler', 'test11667981112715', 1667983755805, 15000);
...
-- ----------------------------
INSERT INTO `QRTZ_TRIGGERS` VALUES ('OakerScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1667981120000, -1, 5, 'PAUSED', 'CRON', 1667981112000, 0, NULL, -1, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('OakerScheduler', 'TASK_CLASS_NAME100', 'DEFAULT', 'TASK_CLASS_NAME100', 'DEFAULT', NULL, 1668013200000, -1, 5, 'WAITING', 'CRON', 1667981112000, 0, NULL, -1, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('OakerScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1667981115000, -1, 5, 'PAUSED', 'CRON', 1667981112000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('OakerScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1667981120000, -1, 5, 'PAUSED', 'CRON', 1667981112000, 0, NULL, 2, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '成本记录表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 609 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2071 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '菜单权限表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_menu` VALUES (103, '部门管理', 2000, 4, 'dept', 'system/dept/index', 1, 0, 'C', '0', '0', 'system:dept:list', 'tree', 'admin', '2021-08-22 08:37:02', 'admin', '2022-11-09 08:43:59', '部门管理菜单');
...
INSERT INTO `sys_menu` VALUES (2000, '业务管理', 0, 2, 'manage', NULL, 1, 0, 'M', '0', '0', '', 'logininfor', 'admin', '2021-08-30 06:38:25', 'admin', '2022-11-09 08:43:47', '');
...
INSERT INTO `sys_menu` VALUES (2002, '工时管理', 0, 1, 'workingHours', NULL, 1, 0, 'M', '0', '0', '', 'time', 'admin', '2021-09-01 02:12:05', 'admin', '2022-11-09 08:44:27', '');
...
INSERT INTO `sys_menu` VALUES (2059, '总体统计', 2002, 4, 'overallStatistics', 'workingHours/overallStatistics', 1, 0, 'C', '0', '0', 'system:project:overall:detail', 'server', 'admin', '2021-11-10 11:44:27', 'admin', '2021-11-11 13:43:59', '');
INSERT INTO `sys_menu` VALUES (2060, '应用设置', 2000, 6, 'appsSett', 'manage/appsSett', 1, 0, 'C', '0', '0', 'system:app:config:edit', 'online', 'admin', '2021-11-03 11:54:49', 'admin', '2021-11-03 14:11:47', '');
INSERT INTO `sys_menu` VALUES (2061, '系统设置', 2000, 7, 'setEditor', 'manage/setEditor', 1, 0, 'C', '0', '0', 'system:info:config:edit', 'system', 'admin', '2021-11-03 11:55:46', 'admin', '2021-11-03 14:24:33', '');
INSERT INTO `sys_menu` VALUES (2062, '成本设置', 2000, 8, 'costOf', 'manage/costOf', 1, 0, 'C', '0', '0', 'mh:cost:set', 'form', 'admin', '2021-11-04 13:43:30', 'admin', '2021-11-11 11:24:28', '');
...
INSERT INTO `sys_menu` VALUES (2069, '项目日报', 2002, 2, 'projectDai', 'workingHours/projectDai', 1, 0, 'C', '0', '0', 'system:project:daily', 'date', 'LSM-admin', '2021-12-14 14:38:36', 'admin', '2021-12-15 16:50:09', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 610 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '系统管理员', '01', '123456@123.com', '18888888888', '1', '/profile/avatar/2022/11/09/7ce0be0f-4d94-437a-bfe8-8c187789cea7.jpeg', '$2a$10$G7MIGBZKPDSD.zGpDPRiJeV3HuOXxk4qEVdQAaZ8pmHHaVRoiDIom', '0', '0', '172.17.0.4', '2022-11-09 16:27:14', 'admin', '2021-08-22 08:37:02', '', '2022-11-09 08:27:14', '管理员');
